...
- Support for address-based and label-based memory access
...
| **Branch Operations**     |
| 0x03                      | BEQ      | `BEQ [label]`               | Branch to label if Z flag is set (result was zero)     | None           |
| 0x04                      | BNE      | `BNE [label]`               | Branch to label if Z flag is not set (result non-zero) | None           |
| 0x05                      | B        | `B [label]`                 | Branch unconditionally to label                        | None           |
| 0x06                      | BL       | `BL [label]`                | Branch to label and store return address in R3         | None           |
...
- `[addr]` = Memory address (register or label)
